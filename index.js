                            ...
                            if (error) {
                                ...
                                parseXmlString(response.text, function (errXmlParse, result) {
                                    if (errXmlParse) {
                                        ...
                                        tdxApi.updateDatasetData(packageParams.gpsDataTable, entry, true, function (errAdd, resAdd) {
                                            if (errAdd) {
                                                ...
                                                tdxApi.updateDatasetData(packageParams.gpsDataTableLatest, entry, true, function (errUpdate, resUpdate) {
                                                    if (errUpdate) {
